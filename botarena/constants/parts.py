...
DLZ_100 = Chassis(
    ...
    speed=100,
    rotation_speed=35,
    turret_rotation_speed=40,  # Light chassis - fast turret tracking
    cost=3000,
    weight_capacity=16,
    self_weight=5,
    shielding=50,
...
DLZ_250 = Chassis(
    ...
    speed=85,
    rotation_speed=30,
    turret_rotation_speed=35,  # Medium chassis - good turret tracking
    cost=4000,
    weight_capacity=22,
    self_weight=8,
    shielding=100,
...
SMARTMOVE = Chassis(
    ...
    speed=75,
    rotation_speed=25,
    turret_rotation_speed=32,  # Heavy chassis with smart targeting
    cost=5500,
    weight_capacity=30,
    self_weight=10,
    shielding=200,
...
CLR_Z050 = Chassis(
    ...
    speed=60,
    rotation_speed=22,
    turret_rotation_speed=28,  # Assault chassis - moderate turret tracking
    cost=7500,
    weight_capacity=50,
    self_weight=15,
    shielding=400,
...
ELECTRON = Chassis(
    ...
    speed=58,
    rotation_speed=19,
    turret_rotation_speed=30,  # Advanced AI chassis - better turret tracking
    cost=8000,
    weight_capacity=64,
    self_weight=19,
    shielding=550,
...
DURICHAS = Chassis(
    ...
    speed=42,
    rotation_speed=14,
    turret_rotation_speed=22,  # Fortress chassis - slower turret
    cost=12000,
    weight_capacity=70,
    self_weight=26,
    shielding=1200,
...
DELIVERANCE = Chassis(
    ...
    speed=40,
    rotation_speed=12,
    turret_rotation_speed=20,  # Heavy war machine - slowest turret
    cost=13000,
    weight_capacity=85,
    self_weight=30,
    shielding=1000,
