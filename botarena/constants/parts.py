...
DLZ_100 = Chassis(
    ...
    speed=70,  # Fast and nimble starter
    rotation_speed=60,  # Quick turns
    turret_rotation_speed=75,  # Snappy turret tracking
    cost=3000,
    weight_capacity=16,
    self_weight=5,
    shielding=50,
    intelligence=4,  # Basic targeting AI
    agility=0.85,
...
DLZ_250 = Chassis(
    ...
    speed=65,  # Balanced speed
    rotation_speed=50,  # Decent rotation
    turret_rotation_speed=65,  # Good turret tracking
    cost=4000,
    weight_capacity=22,
    self_weight=8,
    shielding=100,
    intelligence=5,  # Standard targeting AI
    agility=0.75,
...
# ═══════════════════════════════════════════════════════════════════════
# HEAVY CHASSIS - Smart targeting platform
# ═══════════════════════════════════════════════════════════════════════
SMARTMOVE = Chassis(
    name="Smartmove",  # Heavy - Available at battle 5
    weight_class=WeightClass.HEAVY,
    speed=55,  # Slower but smart
    rotation_speed=40,  # Methodical turns
    turret_rotation_speed=80,  # EXCELLENT turret - the "smart" in Smartmove
    cost=5500,
    weight_capacity=30,
    self_weight=10,
    shielding=200,
    intelligence=8,  # Superior AI - picks optimal targets
    agility=0.90,
...
CLR_Z050 = Chassis(
    ...
    speed=60,  # Assault speed - not slow despite size
    rotation_speed=35,  # Slower hull rotation
    turret_rotation_speed=55,  # Moderate turret tracking
    cost=7500,
    weight_capacity=50,
    self_weight=15,
    shielding=400,
    intelligence=6,  # Good targeting
    agility=0.50,
...
ELECTRON = Chassis(
    ...
    weight_class=WeightClass.ASSAULT,
    speed=65,  # Fast for an assault chassis - high tech
    rotation_speed=45,  # Good hull rotation
    turret_rotation_speed=85,  # Advanced tracking systems
    cost=8000,
    weight_capacity=64,
    self_weight=19,
    shielding=550,
    intelligence=9,  # Near-perfect target selection
    agility=0.55,
...
DURICHAS = Chassis(
    ...
    weight_class=WeightClass.ASSAULT,
    speed=45,  # Slow fortress - trades speed for armor
    rotation_speed=25,  # Sluggish hull rotation
    turret_rotation_speed=40,  # Slower turret tracking
    cost=12000,
    weight_capacity=70,
    self_weight=26,
    shielding=1200,
    intelligence=5,  # Standard AI - brute force over finesse
    agility=0.25,
...
DELIVERANCE = Chassis(
    ...
    weight_class=WeightClass.ASSAULT,
    speed=50,  # Moderate speed - balanced assault platform
    rotation_speed=30,  # Heavy hull rotation
    turret_rotation_speed=70,  # Good turret for its size
    cost=13000,
    weight_capacity=85,
    self_weight=30,
    shielding=1000,
