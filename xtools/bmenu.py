...
class SearchButton(discord.ui.Button):
    def __init__(self, emoji: str):
        super().__init__(style=discord.ButtonStyle.green, emoji=emoji)
        self.emoji = emoji
...
class MenuView(discord.ui.View):
    ...
    def __init__(
        ...
        if search:
            self.add_item(SearchButton("\N{LEFT-POINTING MAGNIFYING GLASS}"))
...
async def menu(
    ...
    m = MenuView(ctx, pages, controls, message, page, timeout, search)
    await m.start()
