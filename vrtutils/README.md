...
Unobfuscate a Teredo IPv6 address<br/>
...
Manage bot's per server bio, banner, and avatar.<br/>
...
Get a json file containing all non-bot usernames/ID's in this guild<br/>
...
Delete an API key from the bot's config<br/>

WARNING: This is irreversible and will delete the key from the bot's config!<br/>
