...
| XTools | ✓ | <details><summary>Get your Xbox profile info in a clean embed.</summary> Various tools for Xbox using xbl.io API.  (You will need to register for a key to use this cog. "its free though")</details> |
