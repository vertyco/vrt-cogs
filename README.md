...
| [BotArena](botarena/README.md)       | <details><summary>Build and battle robots!</summary> A recreation of the classic Bot Arena 3 flash game. Build custom robots with chassis, plating, and weapons, then battle through a 15-mission campaign or challenge other players in PvP. Features real-time rendered battle videos!</details> |
...
| [CommandLock](commandlock/README.md)     | <details><summary>Lock cogs or command to specified channels</summary> Redirects users to the allowed channels for a given cog or command, has a configurable role whitelist.</details>                                                                                                                                                                                                                                                                                                                                         |
...
| [GSurveys](gsurveys/README.md)         | <details><summary>Link Google Forms to your economy.</summary> Reward users with virtual currency when they complete a Google Form survey. Uses Discord webhooks and Google Apps Script — no open ports required.</details>                                                                                                                                                                                                                                             |
...
| [ImGen](imgen/README.md)               | <details><summary>Generate and edit images with OpenAI's GPT-Image models.</summary> Create images from text prompts, edit existing images with AI, and iteratively refine results with turn-based editing. Features per-server API keys, role-based access control with cooldowns, and generation logging.</details>                                                                                                                                                  |
