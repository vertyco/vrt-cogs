...
| ATLA | ❌ | <details><summary>(IN CONCEPT, THIS COG DOES NOTHING AT THE MOMENT) Explore the world from Avatar: The Last Airbender and find/raise your own animals from the ATLA universe!</summary> This cog is still in the concept stage and is NOT intended to be downloaded yet.</details> |
...
| LevelUp | ✓ | <details><summary>Streamlined Leveling System.</summary> Simple yet full-featured leveling cog with prestige features and extensive voice tracking options.</details>|
