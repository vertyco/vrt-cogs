...
Reset the list of initialized users for the guild<br/>
...
View the current settings for the guild<br/>
...
Reset all referral data and settings for the guild<br/>
...
Reset all referral settings for the guild<br/>
...
Reset all referral records for the guild<br/>
