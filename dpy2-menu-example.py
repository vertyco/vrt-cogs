...
async def close_menu(instance: MenuButton, interaction: Interaction):
    await interaction.response.defer()
    await interaction.message.delete()
    instance.view.stop()


async def left(instance: MenuButton, interaction: Interaction):
...
async def left10(instance: MenuButton, interaction: Interaction):
...
async def right(instance: MenuButton, interaction: Interaction):
    instance.view.page += 1
    instance.view.page %= len(instance.view.pages)
    await instance.view.handle_page(interaction.response.edit_message)


async def right10(instance: MenuButton, interaction: Interaction):
