...
async def forwards():
    manager = MigrationManager(
        migration_id=ID, app_name="metrics", description=DESCRIPTION
    )

    manager.add_table(
        class_name="GlobalSnapshot",
        tablename="global_snapshot",
        schema=None,
        columns=None,
    )
    ...
    manager.add_table(
        class_name="GuildSnapshot",
        tablename="guild_snapshot",
        schema=None,
        columns=None,
    )

    manager.add_column(
        table_class_name="GlobalSnapshot",
        tablename="global_snapshot",
        column_name="id",
        db_column_name="id",
    ...
    manager.add_column(
        table_class_name="GuildSettings",
        tablename="guild_settings",
        column_name="track_bank",
        db_column_name="track_bank",
    ...
    manager.add_column(
        table_class_name="GuildSettings",
        tablename="guild_settings",
        column_name="track_members",
        db_column_name="track_members",
        column_class_name="Boolean",
        column_class=Boolean,
        params={
            "default": False,
    ...
    manager.add_column(
        table_class_name="GlobalSettings",
        tablename="global_settings",
        column_name="track_performance",
        db_column_name="track_performance",
        column_class_name="Boolean",
        column_class=Boolean,
        params={
            "default": False,
    ...
    manager.add_column(
        table_class_name="GuildSnapshot",
        tablename="guild_snapshot",
        column_name="id",
        db_column_name="id",
        column_class_name="Serial",
