...
class Admin(MixinMeta):
    ...
    async def view_levelup_alerts(self, ctx: commands.Context):
        ...
        embed.add_field(name=_("LevelUp Message"), value=str(conf.levelup_msg or None), inline=False)
        embed.add_field(name=_("LevelUp Role Message"), value=str(conf.role_awarded_msg or None), inline=False)
        await ctx.send(embed=embed)
