...
### [p]weeklyset bonusrole

Add/Remove a bonus role for weekly winners<br/>

These roles will be awarded in addition to the main winner role.<br/>
This allows assigning multiple roles to winners (e.g., one for icon, one for color).<br/>

Use the command with a role already in the list to remove it<br/>

 - Usage: `[p]weeklyset bonusrole <role>`
...
### [p]weeklyset excluderole

Add/Remove a role from the weekly winner exclusion list<br/>

Members with these roles won't be eligible for winning the weekly leaderboard role.<br/>
They will still appear on the leaderboard but won't receive the winner role.<br/>

Use the command with a role already in the exclusion list to remove it<br/>

 - Usage: `[p]weeklyset excluderole <role>`
...
If enabled, level up notifications won't be sent for you in the server<br/>
...
- `minimal` - a minimal profile style focused on stats<br/>
- `gaming` - a gaming themed profile style with a HUD look<br/>
- (WIP) - more to come<br/>
...
Add/Remove a server from the ignore list<br/>
 ...
 - Usage: `[p]levelowner ignore <guild_id>`
...
### [p]levelowner apiworkers

Set the number of workers for the managed API<br/>

**Arguments**<br/>
- `workers`: Number of uvicorn workers (1-32). Set to 0 for auto (cpu_count // 2).<br/>

**Notes**<br/>
- Changes take effect after restarting the managed API.<br/>
- More workers = more concurrent requests, but more memory usage.<br/>
- Recommended: 1 worker per 2 CPU cores.<br/>

 - Usage: `[p]levelowner apiworkers <workers>`

### [p]levelowner managedapi

Toggle the managed local API for high-performance image generation<br/>

The managed API runs uvicorn locally, providing much higher throughput than<br/>
the subprocess method while requiring no external setup.<br/>

**Arguments**<br/>
- `port`: Optional port number (default 6789). Only used when enabling.<br/>

**Notes**<br/>
- The managed API is automatically started on cog load and stopped on unload.<br/>
- If the managed API fails, the cog falls back to subprocess generation.<br/>
- This takes precedence over subprocess but not over an external API URL.<br/>

 - Usage: `[p]levelowner managedapi [port=None]`
...
Set to `none` to disable the external API<br/>

**Notes**<br/>
- If the API fails, the cog will fall back to subprocess image generation.<br/>
...
Toggle purging of config data for guilds the bot is no longer in<br/>
...
**Make sure your guild's leaderboard is public!**<br/>
...
Manage per level command cooldowns<br/>

 - Usage: `[p]levelset cooldowns`

#### [p]levelset cooldowns del

Delete a cooldown for a specific command and level<br/>

 - Usage: `[p]levelset cooldowns del <level> <command>`

#### [p]levelset cooldowns list

List cooldowns for all commands<br/>

 - Usage: `[p]levelset cooldowns list`

#### [p]levelset cooldowns add

Add a cooldown for a command based on level<br/>
Multiple cooldown levels can be set, the cooldown will be applied to members at the specified level and under<br/>

**Warning:** This will override any default cooldowns for the command<br/>

Example:<br/>
[p]lset cooldowns add 5 15 mycommand<br/>
[p]lset cooldowns add 10 5 mycommand<br/>
Members who are level [0, 5] will have a cooldown of 15 seconds for mycommand (including members at level 5)<br/>
Members who are level (5, 10] will have a cooldown of 5 seconds<br/>
Members above level 10 will have no cooldown<br/>
...
#### [p]levelset messages antispam

Anti-spam settings for message XP<br/>

These settings help prevent users from gaming the XP system by sending<br/>
repetitive or similar messages.<br/>

 - Usage: `[p]levelset messages antispam`

##### [p]levelset messages antispam history

Set how many messages to remember for similarity checking<br/>

More messages = more thorough checking but slightly more memory usage.<br/>
Default is 5.<br/>

 - Usage: `[p]levelset messages antispam history <size>`

##### [p]levelset messages antispam similarity

Set the similarity threshold for anti-spam (0-100)<br/>

Messages that are this % similar to recent messages won't earn XP.<br/>
Higher values are more strict (85 = 85% similar messages blocked).<br/>
Default is 85.<br/>

 - Usage: `[p]levelset messages antispam similarity <threshold>`

##### [p]levelset messages antispam toggle

Toggle anti-spam measures on or off<br/>

 - Usage: `[p]levelset messages antispam toggle`

##### [p]levelset messages antispam view

View the current anti-spam settings<br/>

 - Usage: `[p]levelset messages antispam view`

##### [p]levelset messages antispam uniqueratio

Set the minimum unique word ratio (0.0-1.0)<br/>

Messages must have at least this ratio of unique words to total words.<br/>
Lower values are more lenient. Default is 0.4 (40% unique words).<br/>

Example: "hello hello hello world" has 2 unique words out of 4 total = 0.5 ratio<br/>

 - Usage: `[p]levelset messages antispam uniqueratio <ratio>`
...
Set roles/members that bypass level requirement and cooldowns set<br/>

 - Usage: `[p]levelset bypass`

#### [p]levelset bypass role

Add a role to the bypass list.<br/>

Run with no arguments to see all the bypass roles<br/>
Run with a role already in the list to remove it from the list<br/>

 - Usage: `[p]levelset bypass role [role=None]`

#### [p]levelset bypass member

Add a member to the bypass list.<br/>

Run with no arguments to see all the bypass members<br/>
Run with a member already in the list to remove them from the list<br/>
...
Manage level requirement for commands<br/>

 - Usage: `[p]levelset lvlreq`

#### [p]levelset lvlreq list

List all command level requirements<br/>

 - Usage: `[p]levelset lvlreq list`

#### [p]levelset lvlreq del

Delete a level requirement for a command.<br/>

 - Usage: `[p]levelset lvlreq del <command>`

#### [p]levelset lvlreq add

Add a level requirement to a command.<br/>
...
### [p]levelset profilewelcome

Toggle the profile welcome message<br/>

When enabled, users will see a welcome message with instructions the first time they run the profile command.<br/>
When disabled, the welcome message will not be shown.<br/>

 - Usage: `[p]levelset profilewelcome`
...
Channels in the notify ignore list won't have level up notifications sent there<br/>
