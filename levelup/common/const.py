...
PROFILE_TYPES = ["default", "minimal", "gaming", "runescape"]
STATIC_FONT_STYLES = ["runescape", "gaming"]
...
NOSPACE = {k.replace(" ", ""): v for k, v in COLORS.items() if " " in k}
COLORS = {**COLORS, **NOSPACE}
